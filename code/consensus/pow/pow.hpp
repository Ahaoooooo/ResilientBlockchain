#ifndef POW_SERVER_HPP
#define POW_SERVER_HPP
...
public:
    ...
    /*****************/
      //添加弱块的处理操作
    void send_weak_block_to_peers(network_block *nb );   
     //重定义强块传输
    void send_block_to_peers(block *b ); 
    /*
    ...
    */
    ...
    void additional_valid_transaction( uint32_t add_new);
...
private:
  ...
  long double no_verified_transactions = 0;
  ...
  /**********************/
  long double no_valid_transactions = 0;
};
