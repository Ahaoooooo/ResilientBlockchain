...
#define FILE_CONFIGURATION	"./config/_configuration"
#define FILE_ECC_KEY	"./config/_ecc_key"
#define FILE_PEER_IPS	"./config/_peer_ip_allowed"
...
extern uint32_t T_DISCARD[NO_T_DISCARDS];//T_DISCARD是一个数组，NO_T_DISCARDS是数组长度
