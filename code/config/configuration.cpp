...
// Number of chains
uint32_t CHAINS = 1000;//这个定义是初始定义的，后面从_configuration文件中获取真实值
//
...
//
bool fake_transactions = true;//是否用假交易（模拟交易）
//
uint32_t T_DISCARD[6] = { 1 };//discard在英语中的意思是“丢弃”
...
void set_configuration(string filepath)//从_configuration中获得上述各个值的真实值
{
